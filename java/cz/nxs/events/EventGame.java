...
public interface EventGame {
    ...
    public boolean canUseSkill(PlayerEventInfo var1, SkillData var2);

    public void onSkillUse(PlayerEventInfo var1, SkillData var2);
    ...
    public int allowTransformationSkill(PlayerEventInfo var1, SkillData var2);

    public boolean canSaveShortcuts(PlayerEventInfo var1);

    public int isSkillOffensive(SkillData var1);

    public boolean isSkillNeutral(SkillData var1);
