...
public class EventManagement {
    private FastMap<Integer, EditingInfo> _editingInfos = new FastMap();
    public static final int TRAINING_DUMMY_ID = 31691;
    private String[] miniEventEditingPages = new String[]{"Maps", "Modes", "Rewards", "Matches", "Configs"};
    private String[] mainEventEditingPages = new String[]{"Maps", "Rewards", "Configs", "Instances"};
    ...
    public void showMenu(PlayerEventInfo gm, boolean miniEvents) {
        ...
        if (miniEvents) {
            ...
            for (EventType type : EventType.values()) {
                if (!EventConfig.getInstance().isEventAllowed(type) || type.isRegularEvent() || !type.allowEdits()) continue;
                if (EventManager.getInstance().getMiniEvents().get((Object)type) == null) continue;
                for (Map.Entry<Integer, MiniEventManager> e : EventManager.getInstance().getMiniEvents().get((Object)type).entrySet()) {
                    if (!e.getValue().getMode().isAllowed() || !e.getValue().getMode().isRunning()) continue;
                    ...
                    try {
                        ...
                        NexusLoader.debug((String)("sent invalid bypass, event " + type.getAltTitle()), (Level)Level.WARNING);
        ...
        String string = s = EventManager.getInstance().getMainEventManager().autoSchedulerEnabled() ? "<font color=74BE85>Enabled</font>" : "<font color=B46F6B>Disabled</font>";
    ...
    public void viewMiniEventInfo(PlayerEventInfo gm, int modeId, String type) {
        ...
        ((EditingInfo)this._editingInfos.get((Object)gm.getPlayersId())).activeEditingEvent = eventType;
        ((EditingInfo)this._editingInfos.get((Object)gm.getPlayersId())).activeEventModeId = modeId;
    ...
    public void onBypass(PlayerEventInfo gm, String action) {
        try {
            if (!this._editingInfos.containsKey((Object)gm.getPlayersId())) {
                this._editingInfos.put((Object)gm.getPlayersId(), (Object)new EditingInfo());
            }
            ...
            if (action.equals("regall")) {
                ...
                for (PlayerEventInfo player : CallBack.getInstance().getOut().getAllPlayers()) {
                    if (!EventManager.getInstance().getMainEventManager().registerPlayer(player)) continue;
            ...
            if (action.startsWith("new_event")) {
                ...
                if (st.hasMoreTokens()) {
                    ...
                    this.showNewEventMenu(gm, null, false);
                }
                return;
            }
            if (action.startsWith("event_start")) {
                ...
                EventType event = ((EditingInfo)this._editingInfos.get((Object)gm.getPlayersId())).activeEditingEvent;
            ...
            if (action.startsWith("globalconfig_showinfo")) {
                ...
                if (((EditingInfo)this._editingInfos.get((Object)gm.getPlayersId())).activeGlobalConfigKeyShown.equals(key)) {
                    ((EditingInfo)this._editingInfos.get((Object)gm.getPlayersId())).activeGlobalConfigKeyShown = "";
                } else {
                    ((EditingInfo)this._editingInfos.get((Object)gm.getPlayersId())).activeGlobalConfigKeyShown = key;
                }
                this.showGlobalConfigMenu(gm, configType, page);
                return;
            }
            ...
            if (action.startsWith("reload_configs")) {
                Configurable event = EventManager.getInstance().getEvent(((EditingInfo)this._editingInfos.get((Object)gm.getPlayersId())).activeEditingEvent);
                if (event != null) {
                    event.clearConfigs();
                    event.loadConfigs();
                }
                this.showConfigsMenu(gm, ((EditingInfo)this._editingInfos.get((Object)gm.getPlayersId())).activeEditingEvent.getAltTitle(), ((EditingInfo)this._editingInfos.get((Object)Integer.valueOf((int)gm.getPlayersId()))).currentConfigModelPage);
                return;
            }
            if (action.startsWith("expand_configmodel")) {
                ...
                String key = st.nextToken();
                ((EditingInfo)this._editingInfos.get((Object)gm.getPlayersId())).currentConfigModelShownCategory = category;
                if (((EditingInfo)this._editingInfos.get((Object)gm.getPlayersId())).currentConfigModelShown.equals(key)) {
                    ((EditingInfo)this._editingInfos.get((Object)gm.getPlayersId())).currentConfigModelShown = "";
                } else {
                    ((EditingInfo)this._editingInfos.get((Object)gm.getPlayersId())).currentConfigModelShown = key;
                }
                if (category.equals("InstanceType")) {
                    this.showEditMainInstanceTypeWindow(gm, ((EditingInfo)this._editingInfos.get((Object)gm.getPlayersId())).activeEdittingMainInstanceType);
                    return;
                } else if (category.equals("Event")) {
                    this.showConfigsMenu(gm, ((EditingInfo)this._editingInfos.get((Object)gm.getPlayersId())).activeEditingEvent.getAltTitle(), ((EditingInfo)this._editingInfos.get((Object)Integer.valueOf((int)gm.getPlayersId()))).currentConfigModelPage);
                    return;
                } else {
                    if (!category.equals("MapConfig")) return;
                    this.showMapEditationEvents(gm, ((EditingInfo)this._editingInfos.get((Object)gm.getPlayersId())).activeEditingMap);
                }
                return;
            }
            ...
            if (action.startsWith("mini_")) {
                ...
                if (action2.startsWith("edit_event")) {
                    ...
                    String string = event = st.hasMoreTokens() ? st.nextToken() : null;
                    if (event == null) {
                ...
                if (action2.startsWith("set_active_mode")) {
                    StringTokenizer st = new StringTokenizer(action2);
                    st.nextToken();
                    if (((EditingInfo)this._editingInfos.get((Object)gm.getPlayersId())).activeEditingEvent.isRegularEvent()) {
                    ...
                    if (page.equals("menu")) {
                        ...
                        this.showRewardsEditation(gm, ((EditingInfo)this._editingInfos.get((Object)gm.getPlayersId())).activeEditingEvent.getAltTitle(), ((EditingInfo)this._editingInfos.get((Object)gm.getPlayersId())).activeEditingRewardPos, ((EditingInfo)this._editingInfos.get((Object)gm.getPlayersId())).activeEditingRewardParam);
                        return;
                    } else {
                        if (!page.equals("match")) return;
                        this.showMatches(gm);
                    }
                    return;
                }
                ...
                if (action2.startsWith("edit_modes_menu")) {
                    StringTokenizer st = new StringTokenizer(action2);
                    st.nextToken();
                    int modeId = st.hasMoreTokens() ? Integer.parseInt(st.nextToken()) : ((EditingInfo)this._editingInfos.get((Object)gm.getPlayersId())).activeEventModeId;
                ...
                if (action2.startsWith("edit_modes_enabledisable")) {
                    ...
                    boolean b = false;
                    if (st.hasMoreTokens()) {
                        ((EditingInfo)this._editingInfos.get((Object)gm.getPlayersId())).activeEventModeId = Integer.parseInt(st.nextToken());
                        b = true;
                    }
                ...
                if (action2.startsWith("edit_modes_set_name")) {
                    this.setModeName(gm, action2.substring(20), false);
                    this.showEditModeWindow(gm);
                    return;
                }
                if (action2.startsWith("edit_modes_vis_name")) {
                    this.setModeName(gm, action2.substring(20), true);
                    this.showEditModeWindow(gm);
                    return;
                }
                if (action2.startsWith("edit_modes_set_npcid")) {
                    this.setModeNpcId(gm, action2.substring(21));
                    this.showEditModeWindow(gm);
                    return;
                }
                ...
                if (action2.startsWith("edit_modes_scheduler_edit")) {
                    this.showEditModeSchedulerTime(gm, Integer.parseInt(action2.substring(26)));
                    return;
                }
                if (action2.startsWith("edit_modes_scheduler_removeday")) {
                    this.schedulerRemoveDay(gm, action2.substring(31));
                    this.showEditModeSchedulerTime(gm);
                    return;
                }
                if (action2.startsWith("edit_modes_scheduler_addday")) {
                    this.schedulerAddDay(gm, action2.substring(28));
                    this.showEditModeSchedulerTime(gm);
                    return;
                }
                if (action2.startsWith("edit_modes_scheduler_set_from")) {
                    this.schedulerSetHour(gm, action2.substring(30), true);
                    this.showEditModeSchedulerTime(gm);
                    return;
                }
                if (action2.startsWith("edit_modes_scheduler_set_to")) {
                    this.schedulerSetHour(gm, action2.substring(28), false);
                    this.showEditModeSchedulerTime(gm);
                    return;
                }
                ...
                if (action2.startsWith("edit_feature_showinfo")) {
                    this.setActiveShowedFeature(gm, action2.substring(22));
                    this.showNewMiniEventFeatureMenu(gm, "Default");
                    return;
                }
                if (action2.startsWith("edit_feature_setcategory")) {
                    this.setActiveFeatureCategory(gm, action2.substring(25));
                    this.showNewMiniEventFeatureMenu(gm, "Default");
                    return;
                }
                if (action2.startsWith("edit_feature_add")) {
                    ...
                    this.showNewMiniEventFeatureMenu(gm, type);
                    return;
                }
                if (action2.startsWith("edit_feature_remove")) {
                    ...
                    this.removeFeature(gm, featureName);
                    this.showModesMenu(gm);
                    return;
                }
                if (action2.startsWith("edit_featureconfig_set ")) {
                    ...
                    this.setFeatureConfigValue(gm, featureName, key, value.substring(0, value.length() - 1));
                    this.showEditFeatureConfig(gm, featureName, key);
                    return;
                }
                ...
                if (action2.startsWith("edit_feature ")) {
                    this.showEditFeature(gm, action2.substring(13));
                    return;
                }
                ...
                if (action2.startsWith("edit_match")) {
                    this.editMatch(gm, Integer.parseInt(action2.substring(11)));
                    return;
                }
                if (action2.startsWith("watch_match")) {
                    this.watchMatch(gm);
                    this.editMatch(gm, ((EditingInfo)this._editingInfos.get((Object)gm.getPlayersId())).activeEditingMatch);
                    return;
                }
                ...
                if (action2.startsWith("show_team_members")) {
                    this.showTeamMembers(gm, Integer.parseInt(action2.substring(18)));
                    return;
                }
                if (!action2.startsWith("manual_match")) return;
                ...
                if (action3.startsWith("add_team")) {
                    ...
                    if (((EditingInfo)this._editingInfos.get((Object)gm.getPlayersId())).manualMatchPlayers.get(teamId) == null) {
                        ((EditingInfo)this._editingInfos.get((Object)gm.getPlayersId())).manualMatchPlayers.put(teamId, new FastList());
                    }
                    ((FastList)((EditingInfo)this._editingInfos.get((Object)gm.getPlayersId())).manualMatchPlayers.get(teamId)).add((Object)gm.getTarget().getEventInfo());
                ...
                if (action3.startsWith("rem_team")) {
                    ...
                    for (Map.Entry e : ((EditingInfo)this._editingInfos.get((Object)gm.getPlayersId())).manualMatchPlayers.entrySet()) {
                        for (PlayerEventInfo player : (FastList)e.getValue()) {
                            if ((id != 0 || player.getPlayersId() != gm.getTarget().getObjectId()) && player.getPlayersId() != id) continue;
                            ((FastList)((EditingInfo)this._editingInfos.get((Object)gm.getPlayersId())).manualMatchPlayers.get(e.getKey())).remove((Object)player);
                ...
                if (action3.startsWith("set_map_menu")) {
                    ...
                    if (action3.startsWith("abort") || !action3.startsWith("clear")) return;
                    ((EditingInfo)this._editingInfos.get((Object)gm.getPlayersId())).manualMatchPlayers.clear();
                    this.showManualMatchMenu(gm);
                }
                return;
            }
            if (action.startsWith("set_aviable")) {
                EventType type = ((EditingInfo)this._editingInfos.get((Object)gm.getPlayersId())).activeEditingEvent;
                if (EventConfig.getInstance().isEventAllowed(type)) {
                    this.removeAviableEvent(gm);
                } else {
                    this.addAviableEvent(gm);
                }
                if (type.isRegularEvent()) {
                    this.showEditEventMenu(gm, type.getAltTitle(), ((EditingInfo)this._editingInfos.get((Object)gm.getPlayersId())).activeEventEditingSection);
                    return;
                } else {
                    this.showEditMiniEventMenu(gm, type, ((EditingInfo)this._editingInfos.get((Object)gm.getPlayersId())).activeEventEditingSection);
                }
                return;
            } else if (action.startsWith("event_configs_menu_page")) {
                int page;
                ((EditingInfo)this._editingInfos.get((Object)Integer.valueOf((int)gm.getPlayersId()))).currentConfigModelPage = page = Integer.parseInt(action.substring(24));
                this.showConfigsMenu(gm, ((EditingInfo)this._editingInfos.get((Object)gm.getPlayersId())).activeEditingEvent.getAltTitle(), ((EditingInfo)this._editingInfos.get((Object)Integer.valueOf((int)gm.getPlayersId()))).currentConfigModelPage);
                return;
            } else if (action.startsWith("show_configs_menu")) {
                ((EditingInfo)this._editingInfos.get((Object)Integer.valueOf((int)gm.getPlayersId()))).currentConfigModelPage = 1;
                ((EditingInfo)this._editingInfos.get((Object)gm.getPlayersId())).activeEditingConfigCategory = "General";
                this.showConfigsMenu(gm, action.substring(18), ((EditingInfo)this._editingInfos.get((Object)Integer.valueOf((int)gm.getPlayersId()))).currentConfigModelPage);
                return;
            } else if (action.startsWith("show_configs_category")) {
                StringTokenizer st = new StringTokenizer(action);
                st.nextToken();
                String cat = st.nextToken();
                ((EditingInfo)this._editingInfos.get((Object)gm.getPlayersId())).activeEditingConfigCategory = cat;
                this.showConfigsMenu(gm, ((EditingInfo)this._editingInfos.get((Object)gm.getPlayersId())).activeEditingEvent.getAltTitle(), ((EditingInfo)this._editingInfos.get((Object)Integer.valueOf((int)gm.getPlayersId()))).currentConfigModelPage);
                return;
                ...
                String category = ((EditingInfo)this._editingInfos.get((Object)gm.getPlayersId())).currentConfigModelShownCategory;
                String config = ((EditingInfo)this._editingInfos.get((Object)gm.getPlayersId())).currentConfigModelShown;
                if (category.equals("InstanceType")) {
                    AbstractMainEvent event = EventManager.getInstance().getMainEvent(((EditingInfo)this._editingInfos.get((Object)gm.getPlayersId())).activeEditingEvent);
                    if (event == null) {
                        gm.sendMessage("This event doesn't exist.");
                        return;
                    }
                    MainEventInstanceType instance = event.getInstanceType(((EditingInfo)this._editingInfos.get((Object)gm.getPlayersId())).activeEdittingMainInstanceType);
                    ((ConfigModel)instance.getConfigs().get((Object)config)).removeMultiAddValueIndex(index);
                    MainEventInstanceTypeManager.getInstance().updateInstanceType(instance);
                    this.showEditMainInstanceTypeWindow(gm, ((EditingInfo)this._editingInfos.get((Object)gm.getPlayersId())).activeEdittingMainInstanceType);
                    return;
                } else if (category.equals("Event")) {
                    NexusLoader.debug((String)("removing on index " + index + " of config " + config));
                    EventConfig.getInstance().removeConfigMultiAddValue(((EditingInfo)this._editingInfos.get((Object)gm.getPlayersId())).activeEditingEvent, config, index);
                    this.showConfigsMenu(gm, ((EditingInfo)this._editingInfos.get((Object)gm.getPlayersId())).activeEditingEvent.getAltTitle(), ((EditingInfo)this._editingInfos.get((Object)Integer.valueOf((int)gm.getPlayersId()))).currentConfigModelPage);
                    return;
                } else {
                    if (!category.equals("MapConfig")) return;
                    EventMap map = EventMapSystem.getInstance().getMapById(((EditingInfo)this._editingInfos.get((Object)gm.getPlayersId())).activeEditingMap);
                    if (map != null) {
                        EventConfig.getInstance().removeMapConfigMultiAddValue(map, ((EditingInfo)this._editingInfos.get((Object)gm.getPlayersId())).activeEditingEvent, config, index);
                        this.showMapEditationEvents(gm, ((EditingInfo)this._editingInfos.get((Object)gm.getPlayersId())).activeEditingMap);
                        return;
                    } else {
                ...
                int id = ((EditingInfo)this._editingInfos.get((Object)gm.getPlayersId())).activeEdittingMainInstanceType;
                this.deleteMainInstanceType(gm, id);
                this.showEditEventInstancesMenu(gm, ((EditingInfo)this._editingInfos.get((Object)gm.getPlayersId())).activeEditingEvent);
                return;
                ...
                if (action.startsWith("tournament_menu ")) return;
                if (action.startsWith("edit_event_map")) {
                    StringTokenizer st = new StringTokenizer(action);
                    st.nextToken();
                    int mapId = Integer.parseInt(st.nextToken());
                    int page = Integer.valueOf(st.nextToken());
                    if (((EditingInfo)this._editingInfos.get((Object)gm.getPlayersId())).activeEditingMap != mapId) {
                        ((EditingInfo)this._editingInfos.get((Object)gm.getPlayersId())).activeEditingMapPage = "Info";
                    }
                    this.showMapEditation(gm, mapId, page, null);
                    return;
                } else if (action.startsWith("edit_map_add_event_menu")) {
                    this.showMapEditationAddEvent(gm, ((EditingInfo)this._editingInfos.get((Object)gm.getPlayersId())).activeEditingMap);
                    return;
                } else if (action.startsWith("set_active_editing_map_event")) {
                    ((EditingInfo)this._editingInfos.get((Object)gm.getPlayersId())).activeEditingMapEvent = EventType.getType(action.substring(29));
                    this.showMapEditationEvents(gm, ((EditingInfo)this._editingInfos.get((Object)gm.getPlayersId())).activeEditingMap);
                    return;
                } else if (action.startsWith("edit_map_page")) {
                    String page = action.substring(14);
                    ((EditingInfo)this._editingInfos.get((Object)gm.getPlayersId())).activeEditingMapPage = page;
                    this.showMapEditation(gm, ((EditingInfo)this._editingInfos.get((Object)gm.getPlayersId())).activeEditingMap, ((EditingInfo)this._editingInfos.get((Object)gm.getPlayersId())).activeEditingPage, null);
                    return;
                    ...
                    if (((EditingInfo)this._editingInfos.get((Object)gm.getPlayersId())).activeEditingSpawn == id) {
                        ((EditingInfo)this._editingInfos.get((Object)gm.getPlayersId())).activeEditingSpawn = 0;
                        gm.removeRadarAllMarkers();
                    } else {
                        ((EditingInfo)this._editingInfos.get((Object)gm.getPlayersId())).activeEditingSpawn = id;
                    ...
                    this.removeMap(gm, ((EditingInfo)this._editingInfos.get((Object)gm.getPlayersId())).activeEditingMap);
                    this.showMiniEventMenu(gm);
                    return;
                    ...
                    if (st.hasMoreTokens()) {
                        ...
                        event = ((EditingInfo)this._editingInfos.get((Object)gm.getPlayersId())).activeEditingEvent.getAltTitle();
                        b = false;
                    }
                    ...
                    if (action.startsWith("show_edit_position_window")) return;
                    if (action.startsWith("add_rewarded_position")) {
                        ...
                        if (pos == null) {
                            ...
                            this.showRewardsEditation(gm, ((EditingInfo)this._editingInfos.get((Object)gm.getPlayersId())).activeEditingEvent.toString(), ((EditingInfo)this._editingInfos.get((Object)gm.getPlayersId())).activeEditingRewardPos, ((EditingInfo)this._editingInfos.get((Object)gm.getPlayersId())).activeEditingRewardParam);
                            return;
                        }
                        ...
                        if (s.startsWith("remove")) {
                            ...
                            this.showRewardEditation(gm, ((EditingInfo)this._editingInfos.get((Object)gm.getPlayersId())).activeEditingReward);
                            return;
                            ...
                            if (!s.startsWith("set_chance")) return;
                        ...
                        if ((((EditingInfo)this._editingInfos.get((Object)gm.getPlayersId())).activeEditingEvent == EventType.TreasureHunt || ((EditingInfo)this._editingInfos.get((Object)gm.getPlayersId())).activeEditingEvent == EventType.TreasureHuntPvp) && id > 0) {
                            this.showSpawn(gm, id, false, false, false);
                        }
                        this.showEditSpawnMenu(gm, ((EditingInfo)this._editingInfos.get((Object)gm.getPlayersId())).activeEditingSpawn);
                        return;
                        ...
                        if (s.startsWith("menu")) {
                            ...
                            if (!s.startsWith("set_npc_id")) return;
            ...
            NexusLoader.debug((String)("GM " + gm.getPlayersName() + " sent invalid bypass: " + action), (Level)Level.WARNING);
            e.printStackTrace();
        }
    }
    ...
    private void showEventOrderMenu(PlayerEventInfo gm, String lastModified) {
        ...
        for (int i = 0; i < dataList.size(); ++i) {
            ...
            if (data == null) {
                NexusLoader.debug((String)("Missing event in eventOrder system with order = " + (i + 1) + " - please correct this in database"), (Level)Level.WARNING);
                continue;
            }
    ...
    private void gmDebug(PlayerEventInfo gm) {
        if (!NexusLoader.isDebugging((PlayerEventInfo)gm)) {
            NexusLoader.addGmDebug((PlayerEventInfo)gm);
            gm.sendMessage("Signed for debugging.");
        } else {
            NexusLoader.removeGmDebug((PlayerEventInfo)gm);
    ...
    private void showGlobalConfigMenu(PlayerEventInfo gm, String configType, int page) {
        ...
        ((EditingInfo)this._editingInfos.get((Object)gm.getPlayersId())).activeGlobalConfigType = configType;
        ((EditingInfo)this._editingInfos.get((Object)gm.getPlayersId())).activeGlobalConfigPage = page;
        ...
        for (GlobalConfigModel config : EventConfig.getInstance().getGlobalConfigs(configType)) {
            ...
            if (configType.equals("GearScore") && config.getKey().startsWith("defVal") || configType.equals("Features") && (count <= startFrom || ++count > showTill)) continue;
            ...
            tb.append("</tr></table>");
            if (((EditingInfo)this._editingInfos.get((Object)gm.getPlayersId())).activeGlobalConfigKeyShown.equals(config.getKey())) {
    ...
    private void showGlobalConfigEditation(PlayerEventInfo gm, String key) {
        ...
        html = html.replaceAll("%page%", "" + ((EditingInfo)this._editingInfos.get((Object)gm.getPlayersId())).activeGlobalConfigPage);
        html = html.replaceAll("%type%", ((EditingInfo)this._editingInfos.get((Object)gm.getPlayersId())).activeGlobalConfigType);
        html = html.replaceAll("%title%", "Nexus Events");
        gm.sendPacket(html);
        gm.sendStaticPacket();
    }
    ...
    private void showNewEventMenu(PlayerEventInfo gm, EventType event, boolean runTimeEdit) {
        ...
        if (event != null && event.isRegularEvent()) {
            ((EditingInfo)this._editingInfos.get((Object)gm.getPlayersId())).activeEditingEvent = event;
        } else if (((EditingInfo)this._editingInfos.get((Object)gm.getPlayersId())).activeEditingEvent != null && ((EditingInfo)this._editingInfos.get((Object)gm.getPlayersId())).activeEditingEvent.isRegularEvent()) {
            event = ((EditingInfo)this._editingInfos.get((Object)gm.getPlayersId())).activeEditingEvent;
        }
        ...
        for (EventType type : EventType.values()) {
            if (!type.isRegularEvent() || !type.allowEdits() || type == EventType.Unassigned || EventManager.getInstance().getMainEvent(type) == null || event != null && event == type) continue;
        ...
        if (event == null) {
            ...
            for (EventMap map : EventMapSystem.getInstance().getMainEventMaps(event)) {
                if (EventManager.getInstance().getMainEvent(event) == null || !EventManager.getInstance().getMainEvent(event).canRun(map)) continue;
        ...
        if (!(((EditingInfo)this._editingInfos.get((Object)gm.getPlayersId())).activeEditingEvent == null || ((EditingInfo)this._editingInfos.get((Object)gm.getPlayersId())).activeEditingEvent.isRegularEvent())) {
            ((EditingInfo)this._editingInfos.get((Object)gm.getPlayersId())).activeEditingEvent = null;
        }
        html = ((EditingInfo)this._editingInfos.get((Object)gm.getPlayersId())).activeEditingEvent == null ? html.replaceAll("%selected%", "<font color=BD8282>No event selected</font>") : html.replaceAll("%selected%", ((EditingInfo)this._editingInfos.get((Object)gm.getPlayersId())).activeEditingEvent.getHtmlTitle());
        if (runTimeEdit) {
    ...
    private void showEditEventInstancesMenu(PlayerEventInfo gm, EventType type) {
        ((EditingInfo)this._editingInfos.get((Object)gm.getPlayersId())).activeEditingEvent = type;
        ...
        if (type != EventType.Unassigned) {
            ...
            tb = new TextBuilder();
            tb.append(((EditingInfo)this._editingInfos.get((Object)gm.getPlayersId())).activeEventEditingSection + ";");
            for (String s : this.mainEventEditingPages) {
                if (s.equals(((EditingInfo)this._editingInfos.get((Object)gm.getPlayersId())).activeEventEditingSection)) continue;
                tb.append(s + ";");
            }
        } else {
    ...
    private void showEditMainInstanceTypeWindow(PlayerEventInfo gm, int id) {
        ...
        ((EditingInfo)this._editingInfos.get((Object)gm.getPlayersId())).activeEdittingMainInstanceType = instance.getId();
        TextBuilder tb = new TextBuilder();
        boolean expanded = false;
        for (Map.Entry e : instance.getConfigs().entrySet()) {
            expanded = ((EditingInfo)this._editingInfos.get((Object)gm.getPlayersId())).currentConfigModelShownCategory.equals("InstanceType") && ((EditingInfo)this._editingInfos.get((Object)gm.getPlayersId())).currentConfigModelShown != null && ((EditingInfo)this._editingInfos.get((Object)gm.getPlayersId())).currentConfigModelShown.equals(((ConfigModel)e.getValue()).getKey());
            if (expanded) {
            ...
            if (expanded) {
                ...
                tb.append("</tr>");
                tb.append("</table>");
                if (((ConfigModel)e.getValue()).getInput() == ConfigModel.InputType.MultiEdit || ((ConfigModel)e.getValue()).getInput() == ConfigModel.InputType.MultiAdd || ((ConfigModel)e.getValue()).getValue().length() > 5) {
                    tb.append("<table width=278 bgcolor=2f2f2f>");
                    tb.append("<tr>");
    ...
    private void showEditEventMenu(PlayerEventInfo gm, String eventName, String page) {
        ...
        ((EditingInfo)this._editingInfos.get((Object)gm.getPlayersId())).activeEditingEvent = type;
        ((EditingInfo)this._editingInfos.get((Object)gm.getPlayersId())).activeEventModeId = 1;
        if (page == null) {
            page = this.mainEventEditingPages[0];
        }
        ((EditingInfo)this._editingInfos.get((Object)gm.getPlayersId())).activeEventEditingSection = page;
    ...
    private void showEditEventsMenu(PlayerEventInfo gm) {
        ...
        for (EventType type : EventType.values()) {
            boolean exists;
            if (!type.isRegularEvent() || !type.allowEdits() || type == EventType.Unassigned) continue;
            boolean bl = exists = EventManager.getInstance().getMainEvent(type) != null;
            if (i == 0) {
                tb.append("<tr>");
            }
            ++i;
    ...
    private void allowDisallowMapMode(PlayerEventInfo gm, String map) {
        MiniEventManager event = EventManager.getInstance().getMiniEvent(((EditingInfo)this._editingInfos.get((Object)gm.getPlayersId())).activeEditingEvent, ((EditingInfo)this._editingInfos.get((Object)gm.getPlayersId())).activeEventModeId);
        if (event == null || ((EditingInfo)this._editingInfos.get((Object)gm.getPlayersId())).activeEditingEvent.isRegularEvent()) {
            gm.sendMessage("This mini event doesn't exist.");
            return;
        }
        EventMode mode = event.getMode();
        int mapId = Integer.parseInt(map);
        if (mode.getDisMaps().contains((Object)mapId)) {
            mode.getDisMaps().remove((Object)mapId);
        } else {
            mode.getDisMaps().add((Object)mapId);
        }
        EventConfig.getInstance().updateEventModes(((EditingInfo)this._editingInfos.get((Object)gm.getPlayersId())).activeEditingEvent, ((EditingInfo)this._editingInfos.get((Object)gm.getPlayersId())).activeEventModeId);
    }
    ...
    private void showEditModeMaps(PlayerEventInfo gm) {
        ...
        for (EventMap map : EventMapSystem.getInstance().getMaps(((EditingInfo)this._editingInfos.get((Object)gm.getPlayersId())).activeEditingEvent).values()) {
            if (event.canRun(map)) {
            ...
            if (mode.getDisMaps().contains((Object)map.getGlobalId())) {
        ...
        html = html.replaceAll("%modeId%", String.valueOf(((EditingInfo)this._editingInfos.get((Object)gm.getPlayersId())).activeEventModeId));
    ...
    private void createNewMode(PlayerEventInfo gm, String modeName) {
        int newModeId = 0;
        for (Map.Entry<Integer, MiniEventManager> e : EventManager.getInstance().getMiniEvents().get((Object)((EditingInfo)this._editingInfos.get((Object)gm.getPlayersId())).activeEditingEvent).entrySet()) {
            if (newModeId >= e.getKey()) continue;
            newModeId = e.getKey();
        }
        MiniEventManager manager = EventManager.getInstance().createManager(((EditingInfo)this._editingInfos.get((Object)gm.getPlayersId())).activeEditingEvent, ++newModeId, modeName, modeName, true);
        if (manager == null) {
            return;
        }
        manager.getMode().setAllowed(false);
        ((EditingInfo)this._editingInfos.get((Object)gm.getPlayersId())).activeEventModeId = newModeId;
        this.showEditModeWindow(gm);
    }
    ...
    private void createNewModeMenu(PlayerEventInfo gm) {
        ...
        html = html.replaceAll("%name%", ((EditingInfo)this._editingInfos.get((Object)gm.getPlayersId())).activeEditingEvent.getHtmlTitle());
        html = html.replaceAll("%type%", ((EditingInfo)this._editingInfos.get((Object)gm.getPlayersId())).activeEditingEvent.getAltTitle());
        html = html.replaceAll("%eventId%", String.valueOf(((EditingInfo)this._editingInfos.get((Object)gm.getPlayersId())).activeEditingEvent.getId()));
        int newModeId = 0;
        for (Map.Entry<Integer, MiniEventManager> e : EventManager.getInstance().getMiniEvents().get((Object)((EditingInfo)this._editingInfos.get((Object)gm.getPlayersId())).activeEditingEvent).entrySet()) {
            if (newModeId >= e.getKey()) continue;
            newModeId = e.getKey();
    ...
    private void deleteMode(PlayerEventInfo gm) {
        ...
        if (((EditingInfo)this._editingInfos.get((Object)gm.getPlayersId())).activeEventModeId == 1) {
            gm.sendMessage("You can't delete the default mode. You may only disable it.");
            return;
        }
        event.cleanMe(true);
        EventManager.getInstance().getMiniEvents().get((Object)((EditingInfo)this._editingInfos.get((Object)gm.getPlayersId())).activeEditingEvent).remove(((EditingInfo)this._editingInfos.get((Object)gm.getPlayersId())).activeEventModeId);
        EventConfig.getInstance().updateEventModes(((EditingInfo)this._editingInfos.get((Object)gm.getPlayersId())).activeEditingEvent, 0);
        ((EditingInfo)this._editingInfos.get((Object)gm.getPlayersId())).activeEventModeId = 1;
    }
    ...
    private void scheduleRemoveTime(PlayerEventInfo gm) {
        ...
        ScheduleInfo.RunTime time = event.getMode().getScheduleInfo().getTimes().get(((EditingInfo)this._editingInfos.get((Object)gm.getPlayersId())).activeEventModeTimeId);
        if (time == null) {
            gm.sendMessage("RunTime object with ID " + ((EditingInfo)this._editingInfos.get((Object)gm.getPlayersId())).activeEventModeTimeId + " does not exist.");
            return;
        }
        event.getMode().getScheduleInfo().getTimes().remove(time.id);
        EventConfig.getInstance().updateEventModes(((EditingInfo)this._editingInfos.get((Object)gm.getPlayersId())).activeEditingEvent, ((EditingInfo)this._editingInfos.get((Object)gm.getPlayersId())).activeEventModeId);
        ((EditingInfo)this._editingInfos.get((Object)gm.getPlayersId())).activeEventModeTimeId = 0;
    }
    ...
    private void schedulerAddDay(PlayerEventInfo gm, String dayName) {
        ...
        if (dayName.equals("AllDays")) {
            for (ScheduleInfo.Day d : ScheduleInfo.Day.values()) {
                if (time.days.contains((Object)d)) continue;
                time.days.add(d);
            }
        } else {
            ScheduleInfo.Day d = ScheduleInfo.Day.getDayByName(dayName);
            if (!time.days.contains((Object)d)) {
                time.days.add(d);
            } else {
    ...
    private void schedulerRemoveDay(PlayerEventInfo gm, String dayPrefix) {
        ...
        time.days.remove((Object)ScheduleInfo.Day.getDay(dayPrefix));
        EventConfig.getInstance().updateEventModes(((EditingInfo)this._editingInfos.get((Object)gm.getPlayersId())).activeEditingEvent, ((EditingInfo)this._editingInfos.get((Object)gm.getPlayersId())).activeEventModeId);
    }

    private void showEditModeSchedulerTime(PlayerEventInfo gm) {
        this.showEditModeSchedulerTime(gm, ((EditingInfo)this._editingInfos.get((Object)gm.getPlayersId())).activeEventModeTimeId);
    }
    ...
    private void showEditModeSchedulerTime(PlayerEventInfo gm, int timeId) {
        ...
        ((EditingInfo)this._editingInfos.get((Object)gm.getPlayersId())).activeEventModeTimeId = timeId;
    ...
    private void schedulerAddNewTime(PlayerEventInfo gm) {
        ...
        ((EditingInfo)this._editingInfos.get((Object)gm.getPlayersId())).activeEventModeTimeId = time.id;
        EventConfig.getInstance().updateEventModes(((EditingInfo)this._editingInfos.get((Object)gm.getPlayersId())).activeEditingEvent, time.id);
    }
    ...
    private void showEditModeWindow(PlayerEventInfo gm) {
        this.showEditModeWindow(gm, ((EditingInfo)this._editingInfos.get((Object)gm.getPlayersId())).activeEventModeId);
    }

    private void showEditModeWindow(PlayerEventInfo gm, int modeId) {
        MiniEventManager event = EventManager.getInstance().getMiniEvent(((EditingInfo)this._editingInfos.get((Object)gm.getPlayersId())).activeEditingEvent, modeId);
        ((EditingInfo)this._editingInfos.get((Object)gm.getPlayersId())).activeEventModeId = modeId;
        if (event == null || ((EditingInfo)this._editingInfos.get((Object)gm.getPlayersId())).activeEditingEvent.isRegularEvent()) {
            gm.sendMessage("This mini event doesn't exist.");
            return;
    ...
    private void removeFeature(PlayerEventInfo gm, String featureName) {
        ...
        for (AbstractFeature f : event.getMode().getFeatures()) {
            if (!f.getType().toString().equals(featureName)) continue;
            feature = f;
            break;
        }
        if (feature == null) {
    ...
    private void setActiveFeatureCategory(PlayerEventInfo gm, String categoryName) {
        ...
        if (categoryName.equals("All")) {
            ((EditingInfo)this._editingInfos.get((Object)gm.getPlayersId())).activeEventModeFeatureCategory = null;
            return;
        }
        EventMode.FeatureCategory category = null;
        for (EventMode.FeatureCategory fc : EventMode.FeatureCategory.values()) {
            if (!fc.toString().equalsIgnoreCase(categoryName)) continue;
            category = fc;
            break;
        }
        if (category == null) {
        ...
        ((EditingInfo)this._editingInfos.get((Object)gm.getPlayersId())).activeEventModeFeatureCategory = category;
    }
    ...
    private void setActiveShowedFeature(PlayerEventInfo gm, String featureTypeName) {
        ...
        if (((EditingInfo)this._editingInfos.get((Object)gm.getPlayersId())).activeEventModeFeatureShowed != null && ((EditingInfo)this._editingInfos.get((Object)gm.getPlayersId())).activeEventModeFeatureShowed.toString().equals(featureTypeName)) {
            ((EditingInfo)this._editingInfos.get((Object)gm.getPlayersId())).activeEventModeFeatureShowed = null;
            return;
        }
        for (EventMode.FeatureType type : EventMode.FeatureType.values()) {
            if (!type.toString().equalsIgnoreCase(featureTypeName)) continue;
            ((EditingInfo)this._editingInfos.get((Object)gm.getPlayersId())).activeEventModeFeatureShowed = type;
        }
    }
    ...
    private void showNewMiniEventFeatureMenu(PlayerEventInfo gm, String featureType) {
        ...
        if (!featureType.equals("Default")) {
            ...
            try {
                Object[] objectParams = new Object[]{((EditingInfo)this._editingInfos.get((Object)gm.getPlayersId())).activeEditingEvent, null, null};
            ...
            EventConfig.getInstance().updateEventModes(((EditingInfo)this._editingInfos.get((Object)gm.getPlayersId())).activeEditingEvent, mode.getModeId());
            ((EditingInfo)this._editingInfos.get((Object)gm.getPlayersId())).activeEventModeFeatureShowed = null;
            ((EditingInfo)this._editingInfos.get((Object)gm.getPlayersId())).activeEventModeFeatureCategory = null;
        ...
        for (EventMode.FeatureType feature : EventMode.FeatureType.values()) {
            if (feature.toString().equals(featureType)) continue;
            boolean alreadyIn = false;
            FeatureBase.FeatureInfo info = FeatureBase.getInstance().get(feature);
            if (info == null) {
                NexusLoader.debug((String)("Feature " + feature.toString() + " isn't in FeatureBase."), (Level)Level.WARNING);
                continue;
            }
            boolean allowedForEvent = info.isForEvent(event.getEventType());
            boolean allowedForCategory = ((EditingInfo)this._editingInfos.get((Object)gm.getPlayersId())).activeEventModeFeatureCategory == null || ((EditingInfo)this._editingInfos.get((Object)gm.getPlayersId())).activeEventModeFeatureCategory == info.getCategory();
            for (AbstractFeature f : mode.getFeatures()) {
                if (f.getType() != feature) continue;
                alreadyIn = true;
                break;
            }
            if (alreadyIn || !allowedForEvent || !allowedForCategory) continue;
            tb.append("<table width=275 bgcolor=333333><tr>");
            ...
            tb.append("</tr></table>");
            if (((EditingInfo)this._editingInfos.get((Object)gm.getPlayersId())).activeEventModeFeatureShowed == feature) {
                tb.append("<table width=275><tr>");
        ...
        if (count == 0) {
            String cat = ((EditingInfo)this._editingInfos.get((Object)gm.getPlayersId())).activeEventModeFeatureCategory == null ? "." : " for category " + ((EditingInfo)this._editingInfos.get((Object)gm.getPlayersId())).activeEventModeFeatureCategory.toString() + ".";
            tb.append("<font color=B46F6B>No features are aviable" + cat + "</font>");
        }
        html = html.replaceAll("%features%", tb.toString());
        html = ((EditingInfo)this._editingInfos.get((Object)gm.getPlayersId())).activeEventModeFeatureCategory != null ? html.replaceAll("%category%", ((EditingInfo)this._editingInfos.get((Object)gm.getPlayersId())).activeEventModeFeatureCategory.toString()) : html.replaceAll("%category%", "All");
        html = html.replaceAll("%name%", event.getEventName());
        html = html.replaceAll("%type%", event.getEventType().getAltTitle());
        html = html.replaceAll("%eventId%", String.valueOf(event.getEventType().getId()));
        html = html.replaceAll("%modeId%", String.valueOf(((EditingInfo)this._editingInfos.get((Object)gm.getPlayersId())).activeEventModeId));
    ...
    private void showModesMenu(PlayerEventInfo gm) {
        ...
        if (event == null) {
            ((EditingInfo)this._editingInfos.get((Object)gm.getPlayersId())).activeEventModeId = 1;
            event = EventManager.getInstance().getMiniEvent(((EditingInfo)this._editingInfos.get((Object)gm.getPlayersId())).activeEditingEvent, ((EditingInfo)this._editingInfos.get((Object)gm.getPlayersId())).activeEventModeId);
        }
        if (event == null || ((EditingInfo)this._editingInfos.get((Object)gm.getPlayersId())).activeEditingEvent.isRegularEvent()) {
            gm.sendMessage("This mini event doesn't exist.");
            return;
        ...
        for (Map.Entry<Integer, MiniEventManager> e : EventManager.getInstance().getMiniEvents().get((Object)((EditingInfo)this._editingInfos.get((Object)gm.getPlayersId())).activeEditingEvent).entrySet()) {
            if (e.getValue().getMode().getModeName().equals(event.getMode().getModeName())) continue;
        ...
        for (String page : this.miniEventEditingPages) {
            if (page.equals(((EditingInfo)this._editingInfos.get((Object)gm.getPlayersId())).activeEventEditingSection)) continue;
            tb.append(page + ";");
        }
        result = tb.toString();
        html = html.replaceAll("%event_pages%", result.substring(0, result.length() - 1));
    ...
    private void showManualMatchSetMapMenu(PlayerEventInfo gm) {
        ...
        html = html.replaceAll("%maps%", tb.toString());
        html = html.replaceAll("%mapsAmmount%", String.valueOf(EventMapSystem.getInstance().getMaps(((EditingInfo)this._editingInfos.get((Object)gm.getPlayersId())).activeEditingEvent).values().size()));
        EventMap map2 = EventMapSystem.getInstance().getMapById(((EditingInfo)this._editingInfos.get((Object)gm.getPlayersId())).activeEditingMap);
    ...
    private void editMatch(PlayerEventInfo gm, int matchId) {
        ...
        for (MiniEventGame g : event.getActiveGames()) {
            if (g.getGameId() != matchId) continue;
            game = g;
            break;
        }
        ((EditingInfo)this._editingInfos.get((Object)gm.getPlayersId())).activeEditingMatch = game.getGameId();
    ...
    private void watchMatch(PlayerEventInfo gm) {
        ...
        MiniEventGame game = null;
        for (MiniEventGame g : event.getActiveGames()) {
            if (g.getGameId() != ((EditingInfo)this._editingInfos.get((Object)gm.getPlayersId())).activeEditingMatch) continue;
            game = g;
            break;
        }
        if (game == null) {
    ...
    private void showManualMatchMenu(PlayerEventInfo gm) {
        try {
            ...
            for (Map.Entry e : ((EditingInfo)this._editingInfos.get((Object)gm.getPlayersId())).manualMatchPlayers.entrySet()) {
                for (PlayerEventInfo player : (FastList)e.getValue()) {
                    tb.append("<tr>");
                    tb.append("<td><font color=" + EventManager.getInstance().getTeamColorForHtml((Integer)e.getKey()) + ">" + (player == null || !player.isOnline() ? "Offline. Clear list" : player.getPlayersName()) + "</font></td>");
                    tb.append((Object)("<td><button value=\"Remove\" action=\"bypass admin_event_manage mini_manual_match_rem_team " + (Object)player != null ? Integer.valueOf(player.getPlayersId()) : "0\" width=70 height=19 back=\"L2UI_ct1.button_df\" fore=\"L2UI_ct1.button_df\"></td>"));
                    tb.append("</tr>");
                }
            }
            tb.append("<tr>");
    ...
    private void setManualMatchMap(PlayerEventInfo gm, int mapId) {
        ((EditingInfo)this._editingInfos.get((Object)gm.getPlayersId())).activeEditingMap = mapId;
        gm.sendMessage("Map for this event has been changed.");
    }

    private void startManualMatch(PlayerEventInfo gm) {
        try {
            MiniEventManager manager = EventManager.getInstance().getMiniEvent(((EditingInfo)this._editingInfos.get((Object)gm.getPlayersId())).activeEditingEvent, ((EditingInfo)this._editingInfos.get((Object)gm.getPlayersId())).activeEventModeId);
            RegistrationData[] data = new RegistrationData[((EditingInfo)this._editingInfos.get((Object)gm.getPlayersId())).manualMatchPlayers.size()];
            for (Map.Entry i : ((EditingInfo)this._editingInfos.get((Object)gm.getPlayersId())).manualMatchPlayers.entrySet()) {
                FastList infos = new FastList();
                for (PlayerEventInfo player : (FastList)i.getValue()) {
                    infos.add((Object)CallBack.getInstance().getPlayerBase().addInfo(player));
                }
                data[((Integer)i.getKey()).intValue() - 1] = new RegistrationData(infos);
            }
    ...
    private void showMiniEventMenu(PlayerEventInfo gm) {
        ...
        for (Map.Entry<EventType, Map<Integer, MiniEventManager>> e2 : EventManager.getInstance().getMiniEvents().entrySet()) {
            if (!e2.getKey().allowEdits() || !EventConfig.getInstance().isEventAllowed(e2.getKey())) continue;
            if (i == 0) {
                tb.append("<tr>");
            }
        ...
        for (Map.Entry<EventType, Map<Integer, MiniEventManager>> e2 : EventManager.getInstance().getMiniEvents().entrySet()) {
            if (e2.getKey() == EventType.Unassigned || !e2.getKey().allowEdits() || EventConfig.getInstance().isEventAllowed(e2.getKey())) continue;
            if (i == 0) {
                tb.append("<tr>");
            }
            tb.append("<td><button value=\"" + e2.getKey().getHtmlTitle() + "\" action=\"bypass admin_event_manage mini_edit_event " + e2.getKey().getId() + "\" width=140 height=20 back=\"L2UI_ct1.button_df\" fore=\"L2UI_ct1.button_df\"></td>");
    ...
    private void setModeId(PlayerEventInfo gm, String mode) {
        for (Map.Entry<Integer, MiniEventManager> e : EventManager.getInstance().getMiniEvents().get((Object)((EditingInfo)this._editingInfos.get((Object)gm.getPlayersId())).activeEditingEvent).entrySet()) {
            if (!e.getValue().getMode().getModeName().equals(mode)) continue;
            gm.sendMessage("You're now editting mode " + mode + " (ID " + e.getKey() + ").");
            ((EditingInfo)this._editingInfos.get((Object)gm.getPlayersId())).activeEventModeId = e.getKey();
        }
    }
    ...
    private void addAviableEvent(PlayerEventInfo gm) {
        EventConfig.getInstance().setEventAllowed(((EditingInfo)this._editingInfos.get((Object)gm.getPlayersId())).activeEditingEvent, true);
        gm.sendMessage("Event's been enabled.");
    }

    private void removeAviableEvent(PlayerEventInfo gm) {
        EventConfig.getInstance().setEventAllowed(((EditingInfo)this._editingInfos.get((Object)gm.getPlayersId())).activeEditingEvent, false);
    ...
    private void showSpawnTypeInfoMenu(PlayerEventInfo gm) {
        ...
        TextBuilder tb = new TextBuilder();
        for (EventType type : EventType.values()) {
            if (type == EventType.Unassigned || type == EventType.Tournament) continue;
        ...
        html = html.replaceAll("%events%", tb.toString());
        html = html.replaceAll("%spawnId%", String.valueOf(((EditingInfo)this._editingInfos.get((Object)gm.getPlayersId())).activeEditingSpawn));
        html = html.replaceAll("%title%", "Nexus Events");
        gm.sendPacket(html);
        gm.sendStaticPacket();
    }
    ...
    private void showSpawnTypeInfoEvent(PlayerEventInfo gm, String eventName) {
        EventType type = null;
        for (EventType t : EventType.values()) {
            if (!t.getAltTitle().equals(eventName)) continue;
            type = t;
        }
        if (type == null) {
    ...
    private void showEditMiniEventMenu(PlayerEventInfo gm, EventType type, String page) {
        ...
        ((EditingInfo)this._editingInfos.get((Object)gm.getPlayersId())).activeEventEditingSection = page;
        MiniEventManager event = EventManager.getInstance().getMiniEvent(type, ((EditingInfo)this._editingInfos.get((Object)gm.getPlayersId())).activeEventModeId);
        if (type != EventType.Unassigned) {
            if (event == null) {
    ...
    private void removeReward(PlayerEventInfo gm) {
        EventRewardSystem.RewardItem item = EventRewardSystem.getInstance().getReward(((EditingInfo)this._editingInfos.get((Object)gm.getPlayersId())).activeEditingEvent, ((EditingInfo)this._editingInfos.get((Object)gm.getPlayersId())).activeEventModeId, ((EditingInfo)this._editingInfos.get((Object)gm.getPlayersId())).activeEditingReward);
        if (item == null) {
            gm.sendMessage("This item doesn't exist.");
            return;
        }
        EventRewardSystem.getInstance().removeRewardFromDb(((EditingInfo)this._editingInfos.get((Object)gm.getPlayersId())).activeEditingEvent, ((EditingInfo)this._editingInfos.get((Object)gm.getPlayersId())).activeEditingReward, ((EditingInfo)this._editingInfos.get((Object)gm.getPlayersId())).activeEventModeId);
    }
    ...
    private void editReward(PlayerEventInfo gm, String parameter, String action) {
        ...
        EventRewardSystem.PositionContainer container = EventRewardSystem.getInstance().getRewardPosition(((EditingInfo)this._editingInfos.get((Object)gm.getPlayersId())).activeEditingEvent, ((EditingInfo)this._editingInfos.get((Object)gm.getPlayersId())).activeEventModeId, ((EditingInfo)this._editingInfos.get((Object)gm.getPlayersId())).activeEditingReward);
        EventRewardSystem.getInstance().removeFromDb(((EditingInfo)this._editingInfos.get((Object)gm.getPlayersId())).activeEditingEvent, container.position, container.parameter, ((EditingInfo)this._editingInfos.get((Object)gm.getPlayersId())).activeEventModeId, item.id, item.minAmmount, item.maxAmmount, item.chance);
        ...
        EventRewardSystem.getInstance().addRewardToDb(((EditingInfo)this._editingInfos.get((Object)gm.getPlayersId())).activeEditingEvent, container.position, container.parameter, ((EditingInfo)this._editingInfos.get((Object)gm.getPlayersId())).activeEventModeId, item.id, item.minAmmount, item.maxAmmount, item.chance, true);
    }

    private void addEventReward(PlayerEventInfo gm) {
        if (((EditingInfo)this._editingInfos.get((Object)gm.getPlayersId())).activeEditingEvent == null) {
            gm.sendMessage("This event doesn't exist.");
            return;
        }
        if (((EditingInfo)this._editingInfos.get((Object)gm.getPlayersId())).activeEditingRewardPos == RewardPosition.None) {
            gm.sendMessage("Select a position first.");
            this.showRewardsEditation(gm, ((EditingInfo)this._editingInfos.get((Object)gm.getPlayersId())).activeEditingEvent.getAltTitle(), ((EditingInfo)this._editingInfos.get((Object)gm.getPlayersId())).activeEditingRewardPos, ((EditingInfo)this._editingInfos.get((Object)gm.getPlayersId())).activeEditingRewardParam);
            return;
        }
        int rewardId = EventRewardSystem.getInstance().createReward(((EditingInfo)this._editingInfos.get((Object)gm.getPlayersId())).activeEditingEvent, ((EditingInfo)this._editingInfos.get((Object)gm.getPlayersId())).activeEditingRewardPos, ((EditingInfo)this._editingInfos.get((Object)gm.getPlayersId())).activeEditingRewardParam, ((EditingInfo)this._editingInfos.get((Object)gm.getPlayersId())).activeEventModeId);
        ((EditingInfo)this._editingInfos.get((Object)gm.getPlayersId())).activeEditingReward = rewardId;
        this.showRewardEditation(gm, ((EditingInfo)this._editingInfos.get((Object)gm.getPlayersId())).activeEditingReward);
    }
    ...
    private void showRewardEditation(PlayerEventInfo gm, int rewardId) {
        ...
        html = html.replaceAll("%eventName%", ((EditingInfo)this._editingInfos.get((Object)gm.getPlayersId())).activeEditingEvent.toString());
        EventRewardSystem.RewardItem item = EventRewardSystem.getInstance().getReward(((EditingInfo)this._editingInfos.get((Object)gm.getPlayersId())).activeEditingEvent, ((EditingInfo)this._editingInfos.get((Object)gm.getPlayersId())).activeEventModeId, rewardId);
        if (item == null) {
            gm.sendMessage("This item doesn't exist.");
            return;
        }
    ...
    private void showRewardsEditation(PlayerEventInfo gm, String event, RewardPosition position, String parameter) {
        ...
        EventType type = null;
        for (EventType t : EventType.values()) {
            if (!t.toString().equalsIgnoreCase(event) && !t.getAltTitle().equalsIgnoreCase(event)) continue;
            type = t;
        }
        ...
        ((EditingInfo)this._editingInfos.get((Object)gm.getPlayersId())).activeEditingRewardPos = position;
        ((EditingInfo)this._editingInfos.get((Object)gm.getPlayersId())).activeEditingRewardParam = parameter;
        ((EditingInfo)this._editingInfos.get((Object)gm.getPlayersId())).activeEditingEvent = type;
        ...
        if (!type.isRegularEvent()) {
            ...
            for (Map.Entry<Integer, MiniEventManager> e : EventManager.getInstance().getMiniEvents().get((Object)((EditingInfo)this._editingInfos.get((Object)gm.getPlayersId())).activeEditingEvent).entrySet()) {
                if (e.getValue().getMode().getModeName().equals(manager.getMode().getModeName())) continue;
                tb.append(e.getValue().getMode().getModeName() + ";");
            }
            String result = tb.toString();
            html = html.replaceAll("%modes%", result.substring(0, result.length() - 1));
        ...
        tb = new TextBuilder();
        EventRewardSystem.EventRewards rewards = EventRewardSystem.getInstance().getAllRewardsFor(type, ((EditingInfo)this._editingInfos.get((Object)gm.getPlayersId())).activeEventModeId);
        int i = 0;
        if (rewards != null) {
            int size = 0;
            ...
            for (Map.Entry<EventRewardSystem.PositionContainer, Map<Integer, EventRewardSystem.RewardItem>> e : rewards.getAllRewards().entrySet()) {
                if (e.getKey().position == null || e.getKey().position.posType == null) continue;
                if (i == 0) {
                    tb.append("<tr>");
                }
                ...
                if (e.getKey().position.posType == RewardPosition.PositionType.General) {
                    ...
                    size+=e.getKey().position.toString().length() + 9;
                    tb.append((Object)e.getKey().position + " [" + e.getValue().size() + " it.] ");
                }
                tb.append("</a></font></td>");
                if (++i != 5 && size < 40) continue;
                tb.append("</tr>");
                size = 0;
                i = 0;
            }
        ...
        if (position != RewardPosition.None) {
            for (Map.Entry<Integer, EventRewardSystem.RewardItem> e : EventRewardSystem.getInstance().getRewards(type, ((EditingInfo)this._editingInfos.get((Object)gm.getPlayersId())).activeEventModeId, position, parameter).entrySet()) {
    ...
    public void showAddPositionToRewardedWindow(PlayerEventInfo gm) {
        ...
        Configurable eventInstance = !((EditingInfo)this._editingInfos.get((Object)gm.getPlayersId())).activeEditingEvent.isRegularEvent() ? EventManager.getInstance().getMiniEvent(((EditingInfo)this._editingInfos.get((Object)gm.getPlayersId())).activeEditingEvent, 1) : EventManager.getInstance().getMainEvent(((EditingInfo)this._editingInfos.get((Object)gm.getPlayersId())).activeEditingEvent);
        ...
        html = html.replaceAll("%eventName%", ((EditingInfo)this._editingInfos.get((Object)gm.getPlayersId())).activeEditingEvent.toString());
        html = html.replaceAll("%enableDisable%", EventConfig.getInstance().isEventAllowed(((EditingInfo)this._editingInfos.get((Object)gm.getPlayersId())).activeEditingEvent) ? "<font color=74BE85><a action=\"bypass admin_event_manage set_aviable\">Enabled</a></font>" : "<font color=B46F6B><a action=\"bypass admin_event_manage set_aviable\">Disabled</a></font>");
        TextBuilder tb = new TextBuilder();
        tb.append(((EditingInfo)this._editingInfos.get((Object)gm.getPlayersId())).activeEventEditingSection + ";");
        for (String page : ((EditingInfo)this._editingInfos.get((Object)gm.getPlayersId())).activeEditingEvent.isRegularEvent() ? this.mainEventEditingPages : this.miniEventEditingPages) {
            if (page.equals(((EditingInfo)this._editingInfos.get((Object)gm.getPlayersId())).activeEventEditingSection)) continue;
            tb.append(page + ";");
        }
        String result = tb.toString();
        ...
        for (RewardPosition pos222 : eventInstance.getRewardTypes()) {
            if (pos222.posType == null || pos222.posType != RewardPosition.PositionType.General || EventRewardSystem.getInstance().getAllRewardsFor(((EditingInfo)this._editingInfos.get((Object)gm.getPlayersId())).activeEditingEvent, ((EditingInfo)this._editingInfos.get((Object)gm.getPlayersId())).activeEventModeId).getContainer(pos222, null) != null) continue;
            ++count;
        ...
        count = 0;
        for (RewardPosition pos222 : eventInstance.getRewardTypes()) {
            if (pos222.posType == null || pos222.posType != RewardPosition.PositionType.Numbered || pos222 == RewardPosition.KillingSpree) continue;
            ++count;
        }
        if (count > 0) {
            ++total;
        ...
        count = 0;
        for (RewardPosition pos222 : eventInstance.getRewardTypes()) {
            if (pos222.posType == null || pos222.posType != RewardPosition.PositionType.Range) continue;
            ++count;
        }
        if (count > 0) {
            ++total;
        ...
        for (RewardPosition pos3 : eventInstance.getRewardTypes()) {
            if (pos3.posType == null || pos3.posType != RewardPosition.PositionType.EventSpecific || EventRewardSystem.getInstance().getAllRewardsFor(((EditingInfo)this._editingInfos.get((Object)gm.getPlayersId())).activeEditingEvent, ((EditingInfo)this._editingInfos.get((Object)gm.getPlayersId())).activeEventModeId).getContainer(pos3, null) != null) continue;
            ++count;
    ...
    public void addPositionToRewarded(PlayerEventInfo gm, RewardPosition position, String param) {
        if (EventRewardSystem.getInstance().setPositionRewarded(((EditingInfo)this._editingInfos.get((Object)gm.getPlayersId())).activeEditingEvent, ((EditingInfo)this._editingInfos.get((Object)gm.getPlayersId())).activeEventModeId, position, param)) {
    ...
    public void removePositionFromRewarded(PlayerEventInfo gm, RewardPosition position, String param) {
        if (EventRewardSystem.getInstance().removePositionRewarded(((EditingInfo)this._editingInfos.get((Object)gm.getPlayersId())).activeEditingEvent, ((EditingInfo)this._editingInfos.get((Object)gm.getPlayersId())).activeEventModeId, ((EditingInfo)this._editingInfos.get((Object)gm.getPlayersId())).activeEditingRewardPos, ((EditingInfo)this._editingInfos.get((Object)gm.getPlayersId())).activeEditingRewardParam)) {
            gm.sendMessage("The position has been removed");
        } else {
            gm.sendMessage("This position doesn't exist in the list.");
        }
        ((EditingInfo)this._editingInfos.get((Object)gm.getPlayersId())).activeEditingRewardPos = RewardPosition.None;
        ((EditingInfo)this._editingInfos.get((Object)gm.getPlayersId())).activeEditingRewardParam = null;
        this.showRewardsEditation(gm, ((EditingInfo)this._editingInfos.get((Object)gm.getPlayersId())).activeEditingEvent.getAltTitle(), ((EditingInfo)this._editingInfos.get((Object)gm.getPlayersId())).activeEditingRewardPos, ((EditingInfo)this._editingInfos.get((Object)gm.getPlayersId())).activeEditingRewardParam);
    }
    ...
    private int newSpawn(PlayerEventInfo gm) {
        EventMap map = EventMapSystem.getInstance().getMapById(((EditingInfo)this._editingInfos.get((Object)gm.getPlayersId())).activeEditingMap);
        if (map == null) {
            gm.sendMessage("This map doesn't exist. (" + ((EditingInfo)this._editingInfos.get((Object)gm.getPlayersId())).activeEditingMap + ").");
            return -1;
        }
        if (map.getEvents().contains((Object)EventType.TreasureHunt) || map.getEvents().contains((Object)EventType.TreasureHuntPvp)) {
        ...
        EventSpawn spawn = new EventSpawn(((EditingInfo)this._editingInfos.get((Object)gm.getPlayersId())).activeEditingMap, newId, new Loc(gm.getX(), gm.getY(), gm.getZ()), 0, "RegularSpawn");
        if (((EditingInfo)this._editingInfos.get((Object)gm.getPlayersId())).activeEditingEvent == EventType.TreasureHunt || ((EditingInfo)this._editingInfos.get((Object)gm.getPlayersId())).activeEditingEvent == EventType.TreasureHuntPvp) {
            spawn.setType("Chest");
        }
        spawn.setSaved(false);
        FastList list = new FastList();
        list.add(spawn);
        map.addSpawns((List<EventSpawn>)list);
        ((EditingInfo)this._editingInfos.get((Object)gm.getPlayersId())).activeEditingSpawn = newId;
        return newId;
    }
    ...
    private void saveSpawn(PlayerEventInfo gm) {
        map = EventMapSystem.getInstance().getMapById(EditingInfo.access$700((EditingInfo)this._editingInfos.get((Object)gm.getPlayersId())));
        if (map == null) {
            gm.sendMessage("This map doesn't exist. (" + EditingInfo.access$700((EditingInfo)this._editingInfos.get((Object)gm.getPlayersId())) + ").");
            return;
        }
        spawn = map.getSpawn(EditingInfo.access$1700((EditingInfo)this._editingInfos.get((Object)gm.getPlayersId())));
        if (spawn == null) {
            gm.sendMessage("The spawn with ID " + EditingInfo.access$1700((EditingInfo)this._editingInfos.get((Object)gm.getPlayersId())) + " doesn't exist.");
            return;
        }
...
lbl35: // 7 sources:
    ...
    private void editSpawn(PlayerEventInfo gm, String parameter, String action) {
        ...
        EventSpawn spawn = map.getSpawn(((EditingInfo)this._editingInfos.get((Object)gm.getPlayersId())).activeEditingSpawn);
        if (spawn == null) {
            gm.sendMessage("The spawn with ID " + ((EditingInfo)this._editingInfos.get((Object)gm.getPlayersId())).activeEditingSpawn + " doesn't exist.");
            return;
        }
        if (action.startsWith("set_id")) {
            spawn.setId(Integer.parseInt(parameter));
            ((EditingInfo)this._editingInfos.get((Object)gm.getPlayersId())).activeEditingSpawn = spawn.getSpawnId();
            ...
            if (!(t = new NpcTemplateData(id = Integer.parseInt(parameter))).exists()) {
    ...
    private void showEditSpawnMenu(PlayerEventInfo gm, int spawnId) {
        ...
        switch (spawn.getSpawnType()) {
            case Base: {
                ...
                if (spawn.getNote() != null && !spawn.getNote().equals("")) break;
            ...
            case Door: {
                ...
                try {
                    ...
                    for (DoorAction a : DoorAction.values()) {
                        if (init.equals(a.toString())) continue;
                    ...
                    for (DoorAction a2 : DoorAction.values()) {
                        if (start.equals(a2.toString())) continue;
        ...
        html = html.replaceAll("%mapId%", String.valueOf(((EditingInfo)this._editingInfos.get((Object)gm.getPlayersId())).activeEditingMap));
        ...
        for (SpawnType type : SpawnType.values()) {
            if (type == spawn.getSpawnType() || !type.isForEvents(map.getEvents())) continue;
    ...
    private NpcData showSpawn(PlayerEventInfo gm, int spawnId, boolean onlyShow, boolean onlyDummy, boolean onlyDespawn) {
        ...
        EventSpawn spawn = map.getSpawn(spawnId);
        if (((EditingInfo)this._editingInfos.get((Object)gm.getPlayersId())).spawned.get(map.getGlobalId()) != null && ((Map)((EditingInfo)this._editingInfos.get((Object)gm.getPlayersId())).spawned.get(map.getGlobalId())).get(spawn.getSpawnId()) != null) {
            if (onlyShow) {
                return null;
            }
            ObjectData o = (ObjectData)((Map)((EditingInfo)this._editingInfos.get((Object)gm.getPlayersId())).spawned.get(map.getGlobalId())).get(spawn.getSpawnId());
            if (o.isFence()) {
            ...
            ((Map)((EditingInfo)this._editingInfos.get((Object)gm.getPlayersId())).spawned.get(map.getGlobalId())).remove(spawn.getSpawnId());
        } else {
            if (onlyDespawn) {
                return null;
            }
            if (spawn != null && spawn.getSpawnType() != SpawnType.Door && spawn.getSpawnType() != SpawnType.Fence) {
                ...
                if (template != null) {
                    try {
                        ...
                        if (((EditingInfo)this._editingInfos.get((Object)gm.getPlayersId())).spawned.get(map.getGlobalId()) == null) {
                            ((EditingInfo)this._editingInfos.get((Object)gm.getPlayersId())).spawned.put(map.getGlobalId(), new FastMap());
                        }
                        ((Map)((EditingInfo)this._editingInfos.get((Object)gm.getPlayersId())).spawned.get(map.getGlobalId())).put(spawn.getSpawnId(), npc.getObjectData());
                        npc.broadcastSkillUse((CharacterData)npc, (CharacterData)npc, 5965, 1);
                        return npc;
                    }
                    catch (Exception e) {
                        e.printStackTrace();
                ...
                FastList f = new FastList();
                f.add(fence);
                CallBack.getInstance().getOut().spawnFences((List<FenceData>)f, gm.getInstanceId());
                if (((EditingInfo)this._editingInfos.get((Object)gm.getPlayersId())).spawned.get(map.getGlobalId()) == null) {
                    ((EditingInfo)this._editingInfos.get((Object)gm.getPlayersId())).spawned.put(map.getGlobalId(), new FastMap());
                }
                ((Map)((EditingInfo)this._editingInfos.get((Object)gm.getPlayersId())).spawned.get(map.getGlobalId())).put(spawn.getSpawnId(), fence);
            } else {
    ...
    private void sortSpawns(PlayerEventInfo gm, String sortType) {
        ...
        if (sortType.equals("id")) {
            if (((EditingInfo)this._editingInfos.get((Object)gm.getPlayersId())).asc) {
                Collections.sort(map.getSpawns(), EventMap.compareByIdDesc);
            } else {
                Collections.sort(map.getSpawns(), EventMap.compareByIdAsc);
            }
            ((EditingInfo)this._editingInfos.get((Object)gm.getPlayersId())).asc = !((EditingInfo)this._editingInfos.get((Object)gm.getPlayersId())).asc;
            gm.sendMessage("Done, spawns sorted " + (((EditingInfo)this._editingInfos.get((Object)gm.getPlayersId())).asc ? "ascending" : "descending") + " by their ID.");
    ...
    private void filterSpawns(PlayerEventInfo gm, String s) {
        ...
        if (!s.equals("All")) {
            for (SpawnType t : SpawnType.values()) {
                if (!t.toString().equalsIgnoreCase(s)) continue;
                type = t;
                break;
            }
        }
        ((EditingInfo)this._editingInfos.get((Object)gm.getPlayersId())).spawnFilter = type;
    ...
    private void showConfigsMenu(PlayerEventInfo gm, String type, int page) {
        ...
        String temp = ((EditingInfo)this._editingInfos.get((Object)gm.getPlayersId())).activeEditingConfigCategory;
        String category = null;
        for (String c : event.getCategories()) {
            if (!c.equals(temp)) continue;
            category = c;
            break;
        }
        if (category == null) {
        ...
        if (((EditingInfo)this._editingInfos.get((Object)Integer.valueOf((int)gm.getPlayersId()))).currentConfigModelPage > maxPages) {
            ((EditingInfo)this._editingInfos.get((Object)Integer.valueOf((int)gm.getPlayersId()))).currentConfigModelPage = 1;
        }
        for (ConfigModel config : configs) {
            ...
            ++counter;
            boolean expanded = ((EditingInfo)this._editingInfos.get((Object)gm.getPlayersId())).currentConfigModelShownCategory.equals("Event") && ((EditingInfo)this._editingInfos.get((Object)gm.getPlayersId())).currentConfigModelShown != null && ((EditingInfo)this._editingInfos.get((Object)gm.getPlayersId())).currentConfigModelShown.equals(config.getKey());
            if (expanded) {
                tb.append("<table width=280 bgcolor=599944>");
            } else {
                tb.append("<table width=280 bgcolor=3f3f3f>");
    ...
    private void setConfig(PlayerEventInfo gm, String key, String value, boolean addToValue) {
        EventType eventType = ((EditingInfo)this._editingInfos.get((Object)gm.getPlayersId())).activeEditingEvent;
    ...
    private void showConfigMenu(PlayerEventInfo gm, String type) {
        ...
        boolean expanded = false;
        int size = 0;
        for (Map.Entry<String, ConfigModel> e : map.getConfigModels().get((Object)event).entrySet()) {
            expanded = ((EditingInfo)this._editingInfos.get((Object)gm.getPlayersId())).currentConfigModelShownCategory.equals("MapConfig") && ((EditingInfo)this._editingInfos.get((Object)gm.getPlayersId())).currentConfigModelShown != null && ((EditingInfo)this._editingInfos.get((Object)gm.getPlayersId())).currentConfigModelShown.equals(e.getValue().getKey());
            if (expanded) {
                tb.append("<table width=280 bgcolor=599944>");
            } else {
                tb.append("<table width=280 bgcolor=3f3f3f>");
        ...
        html = html.replaceAll("%page%", String.valueOf(((EditingInfo)this._editingInfos.get((Object)gm.getPlayersId())).activeEditingPage));
        html = html.replaceAll("%title%", "Nexus Events");
        gm.sendPacket(html);
        gm.sendStaticPacket();
    }
    ...
    private void showMapStatus(PlayerEventInfo gm, int mapId, String event) {
        ...
        ((EditingInfo)this._editingInfos.get((Object)gm.getPlayersId())).activeEditingMap = map.getGlobalId();
    ...
    private void showExpandSpawnEffect(final PlayerEventInfo gm, int spawnId) {
        ...
        CallBack.getInstance().getOut().scheduleGeneral(new Runnable(){
            ...
            @Override
            public void run() {
                EventManagement.this.showSpawn(gm, spawn.getSpawnId(), false, true, false);
            }
        }, 500);
    }
    ...
    private void showMapEditationAddEvent(PlayerEventInfo gm, int mapId) {
        ...
        for (EventType aviable : EventType.values()) {
            if (!aviable.allowEdits() || aviable == EventType.Unassigned || map.getEvents().contains((Object)aviable) || EventManager.getInstance().getEvent(aviable) == null) continue;
            if (++counter == 1) {
                tb.append("<tr>");
            }
    ...
    private void showMapEditationInfo(PlayerEventInfo gm, EventMap map) {
        ...
        TextBuilder tb = new TextBuilder();
        EventType event = ((EditingInfo)this._editingInfos.get((Object)gm.getPlayersId())).activeEditingMapEvent;
        if (event != null) {
            tb.append(event.getAltTitle() + ";");
        }
        for (EventType t : map.getEvents()) {
            if ((event == null || t == event) && event != null) continue;
    ...
    private void showMapEditationEvents(PlayerEventInfo gm, int mapId) {
        ...
        if (event != null && map.getEvents().contains((Object)event)) {
            tb.append(event.getAltTitle() + ";");
            selected = true;
        }
        for (EventType t : map.getEvents()) {
    ...
    private void showMapEditation(PlayerEventInfo gm, int mapId, int page, EventType predefinedEvent) {
        ...
        if (map == null) {
            FastList defaultEvent = new FastList();
            defaultEvent.add(EventType.Unassigned);
            map = new EventMap(EventMapSystem.getInstance().getNewMapId(), "New Map", "", (List<EventType>)defaultEvent, null, "");
            map.setSaved(false);
        ...
        ((EditingInfo)this._editingInfos.get((Object)gm.getPlayersId())).activeEditingPage = page;
        ((EditingInfo)this._editingInfos.get((Object)gm.getPlayersId())).activeEditingMap = map.getGlobalId();
        if (((EditingInfo)this._editingInfos.get((Object)gm.getPlayersId())).activeEditingMapPage != null) {
            if (((EditingInfo)this._editingInfos.get((Object)gm.getPlayersId())).activeEditingMapPage.equals("Events")) {
                this.showMapEditationEvents(gm, mapId);
                return;
            }
            if (((EditingInfo)this._editingInfos.get((Object)gm.getPlayersId())).activeEditingMapPage.equals("Info")) {
                this.showMapEditationInfo(gm, map);
                return;
            }
        }
        TextBuilder tb = new TextBuilder();
        if (((EditingInfo)this._editingInfos.get((Object)gm.getPlayersId())).spawnFilter == null) {
            tb.append("All;");
        } else {
            tb.append(((EditingInfo)this._editingInfos.get((Object)gm.getPlayersId())).spawnFilter.toString() + ";");
        }
        block0 : for (SpawnType t : SpawnType.values()) {
            if (((EditingInfo)this._editingInfos.get((Object)gm.getPlayersId())).spawnFilter != null && ((EditingInfo)this._editingInfos.get((Object)gm.getPlayersId())).spawnFilter == t) continue;
            for (EventSpawn spawn : map.getSpawns()) {
                if (spawn.getSpawnType() != t) continue;
        ...
        boolean filter = ((EditingInfo)this._editingInfos.get((Object)gm.getPlayersId())).spawnFilter != null;
        ...
        tb.append("</table>");
        int size = filter ? map.getSpawns(-1, ((EditingInfo)this._editingInfos.get((Object)gm.getPlayersId())).spawnFilter).size() : map.getSpawns().size();
        ...
        for (EventSpawn spawn : map.getSpawns()) {
            if (filter && spawn.getSpawnType() != ((EditingInfo)this._editingInfos.get((Object)gm.getPlayersId())).spawnFilter || ++count <= firstSpawnShowed || count > lastSpawnShowed) continue;
            String spawnUnspawn = ((EditingInfo)this._editingInfos.get((Object)gm.getPlayersId())).spawned.get(map.getGlobalId()) != null && ((Map)((EditingInfo)this._editingInfos.get((Object)gm.getPlayersId())).spawned.get(map.getGlobalId())).get(spawn.getSpawnId()) != null ? "Hide" : "Show";
            ...
            if (((EditingInfo)this._editingInfos.get((Object)gm.getPlayersId())).activeEditingSpawn != spawn.getSpawnId()) {
            ...
            if (((EditingInfo)this._editingInfos.get((Object)gm.getPlayersId())).activeEditingSpawn == spawn.getSpawnId()) {
                ...
                if (type == EventType.Unassigned) {
                    ...
                    desc = event.getAviableSpawnTypes().get((Object)spawn.getSpawnType());
                }
                if (desc == null) {
                    desc = spawn.getSpawnType().getDefaultDesc();
                }
        ...
        int maxCountOfPagesUsingButtons = 20;
    ...
    private void addAviableEvent(PlayerEventInfo gm, String event) {
        ...
        EventType type = EventType.getType(event);
        if (type != null) {
            if (!map.getEvents().contains((Object)type)) {
                map.addEvent(type);
                map.removeEvent(EventType.Unassigned);
                gm.sendMessage("Done.");
            } else {
    ...
    private void removeAviableEvent(PlayerEventInfo gm, String event) {
        ...
        for (EventType t : map.getEvents()) {
            if (!t.toString().equalsIgnoreCase(event) && !t.getAltTitle().equalsIgnoreCase(event)) continue;
            if (((EditingInfo)this._editingInfos.get((Object)gm.getPlayersId())).activeEditingMapEvent == t) {
                ((EditingInfo)this._editingInfos.get((Object)gm.getPlayersId())).activeEditingMapEvent = null;
            }
            map.removeEvent(t);
            gm.sendMessage("Done.");
            return;
    ...
    private void setGoBackPage(PlayerEventInfo gm, String page) {
        ((EditingInfo)this._editingInfos.get((Object)gm.getPlayersId())).currentGoBackAblePage = page;
    }

    private String getGoBackPage(PlayerEventInfo gm) {
        return ((EditingInfo)this._editingInfos.get((Object)gm.getPlayersId())).currentGoBackAblePage;
    }
    ...
    private class EditingInfo {
        private Map<Integer, Map<Integer, ObjectData>> spawned;
        private int activeEditingMap;
        private String activeEditingMapPage;
        private EventType activeEditingMapEvent;
        private int activeEditingPage;
        private String activeEventEditingSection;
        ...
        private int activeEventModeId;
        private int activeEventModeTimeId;
        private EventMode.FeatureType activeEventModeFeatureShowed;
        private EventMode.FeatureCategory activeEventModeFeatureCategory;
        private int activeEditingMatch;
        private int activeEditingReward;
        private int activeGlobalConfigPage;
        private String activeGlobalConfigType;
        private String activeGlobalConfigKeyShown;
        private int activeEdittingMainInstanceType;
        private String currentGoBackAblePage;
        public int currentConfigModelPage;
        private String currentConfigModelShownCategory;
        private String currentConfigModelShown;
        private SpawnType spawnFilter;
        private boolean asc;
        private Map<Integer, FastList<PlayerEventInfo>> manualMatchPlayers;

        private EditingInfo() {
            this.spawned = new FastMap();
            this.activeEditingMap = 0;
            this.activeEditingMapPage = "Info";
            this.activeEditingMapEvent = null;
            this.activeEditingPage = 0;
            this.activeEventEditingSection = null;
            this.activeEventModeId = 1;
            this.activeEventModeTimeId = 0;
            this.activeEventModeFeatureShowed = null;
            this.activeEventModeFeatureCategory = null;
            this.activeGlobalConfigPage = 0;
            this.activeGlobalConfigType = null;
            this.activeGlobalConfigKeyShown = "";
            this.activeEdittingMainInstanceType = 0;
            this.currentGoBackAblePage = null;
            this.currentConfigModelPage = 1;
            this.currentConfigModelShownCategory = "";
            this.currentConfigModelShown = "";
            this.spawnFilter = null;
            this.asc = false;
            this.manualMatchPlayers = new FastMap(2);
        }
    }
