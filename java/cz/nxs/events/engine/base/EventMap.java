...
public class EventMap
{
	...
	{
		this._configModels.put(event, new FastMap<>());
		...
		{
			this._configModels.get(event).put(config.getKey(), new ConfigModel(config.getKey(), config.getValue(), config.getDesc(), config.getInput()));
		}
	}
	...
	{
		FastList<EventSpawn> temp = new FastList<>();
