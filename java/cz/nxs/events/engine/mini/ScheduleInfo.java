...
{
	private final Map<Integer, RunTime> _times = new FastMap<>();
	...
	public long getNextStart(boolean test)
	{
		...
		long temp = 0;
		for (Map.Entry<Integer, RunTime> time : _times.entrySet())
		{
	...
	public class RunTime
	{
		...
		private Calendar getNextRun(boolean start)
		{
			...
			FastList<Calendar> times = new FastList<>();
