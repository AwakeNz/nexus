    ...
    public String getMissingSpawns() {
        ...
        for (EventType type : this.getEvents()) {
            if (type == EventType.Classic_1v1 || type == EventType.PartyvsParty || type == EventType.TvT || type == EventType.TVTv || type == EventType.MiniTvT) {
                ...
                if (type != EventType.TVTv) continue;
                ...
                if (this.checkForSpawns(SpawnType.VIP, 2, 1)) continue;
            ...
            if (type == EventType.Domination) {
                ...
                if (this.checkForSpawns(SpawnType.Zone, -1, 1)) continue;
            ...
            if (type == EventType.MassDomination) {
                ...
                try {
                    ...
                    if (this.checkForSpawns(SpawnType.Zone, -1, count)) continue;
                    ...
                    e.printStackTrace();
                    if (this.checkForSpawns(SpawnType.Zone, -1, 2)) continue;
            ...
            if (type != EventType.CTF) continue;
